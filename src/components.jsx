...
export const INIT_USERS = [
  ...
  {id:"student1",uid:"ET-003",role:"student",name:"Ana Torres",username:"ana_torres",password:"ana123",email:"ana@gmail.com",active:true,trainerId:"trainer1",planId:"p2",profile:{height:165,weight:62,age:28,gender:"female",goal:"Hipertrofia",activityLevel:"moderado",restrictions:""},attendance:["2026-02-10","2026-02-13","2026-02-17","2026-03-03"],sessions:[{id:"s1",date:"2026-02-10",exercises:[{id:"e1",machineId:"squat_rack",sets:4,reps:10,weight:60},{id:"e2",machineId:"leg_press",sets:3,reps:12,weight:120}]},{id:"s2",date:"2026-02-13",exercises:[{id:"e4",machineId:"incline_press",sets:4,reps:10,weight:45},{id:"e5",machineId:"cable_cross",sets:3,reps:12,weight:20}]},{id:"s3",date:"2026-03-03",exercises:[{id:"e7",machineId:"lat_pulldown",sets:4,reps:10,weight:55},{id:"e8",machineId:"seated_row",sets:3,reps:12,weight:50}]}]},
  {id:"student2",uid:"ET-004",role:"student",name:"Carlos Vásquez",username:"carlos_v",password:"carlos123",email:"carlos@gmail.com",active:true,trainerId:"trainer1",planId:"p4",profile:{height:178,weight:80,age:32,gender:"male",goal:"Fuerza",activityLevel:"activo",restrictions:"Dolor lumbar leve"},attendance:["2026-02-12","2026-02-15","2026-03-01"],sessions:[{id:"s1",date:"2026-02-12",exercises:[{id:"e1",machineId:"squat_rack",sets:5,reps:5,weight:100},{id:"e2",machineId:"barbell_deadlift",sets:4,reps:5,weight:120}]},{id:"s2",date:"2026-03-01",exercises:[{id:"e3",machineId:"incline_press",sets:5,reps:5,weight:70},{id:"e4",machineId:"dips",sets:3,reps:8,weight:20}]}]},
];
let _uidCount = 4;
